...
class AppConfig:
    ...
    def __init__(self) -> None:
        ...
        self.kafka_consumer_topic = str(os.getenv('KAFKA_STG_SERVICE_CONSUMER_TOPIC') or "")
        ...
        self.kafka_producer_topic = str(os.getenv('KAFKA_STG_SERVICE_PRODUCER_TOPIC') or "")
